            ...
            <Row>
               <Col lg='6'>
                  <div className="hero__content">
                     ...
                     <h1>Seamless Stays, Memorable  <span className='hightlight'> Moments.</span></h1>
                     <p>
         ...
         <Container>
            <Row>
               <Col lg='12' className='mb-5'>
                  ...
                  <h2 className='featured__tour-title'>Our Hotels</h2>
               </Col>
               <FeaturedTourList />
            </Row>
         </Container>
         ...
         <Container>
            <Row>
               <Col lg='12'>
                  ...
                  <h2 className="gallery__title">Hotels gallery</h2>
               </Col>
               <Col lg='12'>
